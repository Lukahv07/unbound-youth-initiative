...
const PhotoGalleryCarousel = ({
  ...
  const galleries = [{
    ...
    description: "Our biggest, boldest, and most inspiring race yet—this year's run captured unforgettable moments of unity, resilience, and joy as we pushed past our goals for global smiles. M4S 2025 had the most successful finance team in recent history, with the most extensive list of sponsors and raffle prizes yet. It also strengthened collaboration with Operation Smile to provide the school community a glimpse into the impact the organization has beyond the race.\n\nThe 2025 M4S Executive Council faced some challenges along the way. Due to school administrative decisions, the race's staff was selected three months later than expected. Air quality even forced the team to delay the race. Ultimately, however, M4S staff succeeded in overcoming hurdles and making 2025 a year to remember.\n\nWith guest speakers from Operation Smile Mexico, family testimonies, Yoghurt trucks, kids' play areas, and a professional host, M4S 2025 brought flare, character, and a whole lot of smiles.",
    image: "/lovable-uploads/2d1077b3-de6a-4131-b2f2-5bebb1fccfad.png"
  }, {
    title: "Operation Smile Missions",
    description: "This gallery offers behind-the-scenes glimpses into surgical missions at Christus Muguerza Hospital Sur, where dedicated medical teams and volunteers transform lives one smile at a time. While supporting Operation Smile staff, M4S organizers translated for nurses and surgeons, assisted with medical records, and comforted families awaiting life-changing surgery.\n\nHere, their year-long efforts culminate in the opportunity to see their work manifest. \"It's beautiful to see all hands on deck,\" says one staff member, \"as everyone—from parents to doctors to volunteers—collaborates for a common purpose.\" This year, the M4S team received an honorary recognition on behalf of Operation Smile Mexico for their continued aid in changing lives. Approximately 20 of the surgeries performed during missions can be attributed to the funds raised by M4S members.",
    image: "/lovable-uploads/70847e30-0738-434c-806b-66d49a84c057.png"
  }, {
    title: "Global Citizens Initiative 2025",
    description: "A window into the place that started it all. Located in St. Andrews Scotland, the 2025 GCI Summit brought leaders from around the world together to launch \"Glocal Service Projects (GSPs).\" The 8-day experience—full of Exeter Academy-based Harkness discussions, prototyping, and team building—was quintessential for UNbound's partnership with GCI, which empowered our international network to thrive.\n\nGCI was also the launchpad off of which UNbound sprung forward. In ideating his very own GSP, Founder Lukah Villarreal formulated a question: \"How might we unite Latin American HS communities to launch NGO-partnered fundraising events that follow the Miles for Smiles (Operation Smile) roadmap?\" This question—a story—is at the heart of what UNbound does.",
